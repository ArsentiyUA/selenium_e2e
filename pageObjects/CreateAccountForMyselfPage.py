...
class SystemForMe:
    ...
    def provide_first_name(self):
        return self.driver.find_element(*SystemForMe.first_name_element).send_keys("Arsentiy")

    def provide_last_name(self):
        return self.driver.find_element(*SystemForMe.last_name_element).send_keys("Abramov")

    def provide_email(self):
        return self.driver.find_element(*SystemForMe.email_element).send_keys("arsen@getaloecare.com")

    def provide_phone(self):
        return self.driver.find_element(*SystemForMe.phone_element).send_keys(9292579434)
    ...
    def provide_address1(self):
        return self.driver.find_element(*SystemForMe.address1_element).send_keys("881 Rutland Rd")

    def provide_address2(self):
        return self.driver.find_element(*SystemForMe.address2_element).send_keys("2nd Floor")

    def provide_city(self):
        return self.driver.find_element(*SystemForMe.id_city_element).send_keys("Brooklyn")
    ...
    def provide_zip(self):
        return self.driver.find_element(*SystemForMe.zip_input_element).send_keys(11203)

    def choose_gender(self):
        return self.driver.find_element(*SystemForMe.gender_element).click()

    def submit(self):
        return self.driver.find_element(*SystemForMe.submit_element).click()
